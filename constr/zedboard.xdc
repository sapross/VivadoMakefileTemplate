...
# Frequency: 100 MHz
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y9 [get_ports {SYS_CLK_I}];  # "SYS_CLK_I"
create_clock -name SYSCLK -period 10.00 [get_ports {SYS_CLK_I}];
...
# ----------------------------------------------------------------------------
# OLED_O Display - Bank 13
# ---------------------------------------------------------------------------- 
# set_property PACKAGE_PIN U10  [get_ports {OLED_O_DC}];  # "OLED_O-DC"
# set_property PACKAGE_PIN U9   [get_ports {OLED_O_RES}];  # "OLED_O-RES"
# set_property PACKAGE_PIN AB12 [get_ports {OLED_O_SCLK}];  # "OLED_O-SCLK"
# set_property PACKAGE_PIN AA12 [get_ports {OLED_O_SDIN}];  # "OLED_O-SDIN"
# set_property PACKAGE_PIN U11  [get_ports {OLED_O_VBAT}];  # "OLED_O-VBAT"
# set_property PACKAGE_PIN U12  [get_ports {OLED_O_VDD}];  # "OLED_O-VDD"
...
# User LED_Os - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {LED_O[0]}];  # "LED_O0"
# set_property PACKAGE_PIN T21 [get_ports {LED_O[1]}];  # "LED_O1"
# set_property PACKAGE_PIN U22 [get_ports {LED_O[2]}];  # "LED_O2"
# set_property PACKAGE_PIN U21 [get_ports {LED_O[3]}];  # "LED_O3"
# set_property PACKAGE_PIN V22 [get_ports {LED_O[4]}];  # "LED_O4"
# set_property PACKAGE_PIN W22 [get_ports {LED_O[5]}];  # "LED_O5"
# set_property PACKAGE_PIN U19 [get_ports {LED_O[6]}];  # "LED_O6"
# set_property PACKAGE_PIN U14 [get_ports {LED_O[7]}];  # "LED_O7"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {BTNC_I}];  # "BTNC_I"
# set_property PACKAGE_PIN R16 [get_ports {BTND_I}];  # "BTND_I"
# set_property PACKAGE_PIN N15 [get_ports {BTNL_I}];  # "BTNL_I"
# set_property PACKAGE_PIN R18 [get_ports {BTNR_I}];  # "BTNR_I"
# set_property PACKAGE_PIN T18 [get_ports {BTNU_I}];  # "BTNU_I"
